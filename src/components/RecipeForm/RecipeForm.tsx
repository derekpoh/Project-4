...
const RecipeForm = ({ initialValues, method, url }: { initialValues: RecipeDetails, method: string, url: string }) => {
                    ...
                    return <>
                        {
                            values.ingredients.map((_, index) => (
                              ...
                              >
                                ...
                                _id="name"
                                label="Name*" 
                                value={initialValues.ingredients[index].name}
                                as={TextField}
                                ...
                                _id="quantity"
                                label="Quantity*"
                                value={initialValues.ingredients[index].quantity}
                                as={TextField}
                               ...
                               error={errors.ingredients && errors.ingredients[index]  && errors.ingredients[index].quantity  && touched.ingredients && touched.ingredients[index] && touched.ingredients[index].quantity}
                                ...
                                _id="measurement"
                                label="Measurement"
                                value={initialValues.ingredients[index].measurement}
                                as={TextField}
                                />
                                </Grid>   
                            ...
                            values.instructions.map((_, index) => (
                              ...
                              >
                                ...
                                <Field
                                 ...
                                 id="instructions"
                                 label="Instructions*"
                                 value={initialValues.instructions[index]}
                                 as={TextField}
                           ...
                           {values.imageurl && values.imageurl.map((_, index) => (
                              ...
                              >
                                ...
                                fullWidth
                                 ...
                                 id="imageurl"
                                 label="Imageurl"
                                 value={initialValues.imageurl && initialValues.imageurl[index]}
                                 as={TextField}
