    ...
    return (
      <Box sx={{ marginLeft: "-1415px", marginTop: "300px" }}>
        ...
        <SearchTitle><Typography variant="h4"  marginLeft="15px" marginTop="-5px" color="black" textTransform="uppercase" letterSpacing='0.1em' fontSize="20px" textOverflow="ellipsis" overflow="clip" width="1400px">Best Ratings</Typography></SearchTitle>
         ...
         <SearchTitle><Typography variant="h4"  marginBottom="50px" color="black" textTransform="uppercase" letterSpacing='0.1em' fontSize="28px" textAlign='center' textOverflow="ellipsis" overflow="clip" width="345px">Best Ratings</Typography></SearchTitle>
        )}
...
export default BestRatingsHomePage